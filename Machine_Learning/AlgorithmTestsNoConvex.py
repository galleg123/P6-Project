...
def GridSearchTestsSVCweighted(params, scorer, path, randomState=42):
    ...
    features = ['Area', 'Circularity', 'Rectangularity', 'Elongation', 'Eccentricity']
...
if __name__ == "__main__":
    ...
    functions = [GridSearchTestsSVCweighted]
    argument = {'params':{'C': [0.1, 1, 10, 100], 'gamma': [1, 0.1, 0.01, 0.001], 'kernel': ['rbf', 'linear'],
                     'class_weight': [None, "balanced", {0: 1, 1: 16}, {0: 1, 1: 4}, {0: 1, 1: 3}], "random_state":[42]},
                    'scorer':make_scorer(fbeta_score, beta=4),'path':"Test_Results/SVM_Weights/noConvex/"}
