...
class FeatureExtraction:
	...
	def extractFeatures(self):
		...
		output = open('Extracted_Features/featuresExtracted.csv','w')
		...
		self.dataframe.to_csv('Extracted_Features/featuresExtractedSorted_noDoubleFrames.csv',index=False)
	
		# Split the DataFrame into two based on the value of the ’supercategory'column
		cages_df = self.dataframe[self.dataframe.supercategory == 'cages']
		people_df = self.dataframe[self.dataframe.supercategory == 'people']

		# Write the new DataFrames to CSV files
		cages_df.to_csv('Extracted_Features/cagesExtracted.csv', index = False)
